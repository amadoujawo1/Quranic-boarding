...
export const Home: React.FC = () => {
  ...
  const stats = [
    { title: 'Students Enrolled', num: 450, suffix: '+', icon: Users },
    { title: 'Hifz Huffaz Graduates', num: 180, suffix: '+', icon: Award },
    { title: 'Qualified Teachers', num: 38, suffix: '', icon: BookOpen },
    { title: 'Hostel Capacity', num: 400, suffix: ' Beds', icon: HomeIcon },
  ];
  ...
  const testimonials = [
    {
      quote: "QBSMS provided my son with the ideal environment to complete his Hifz while scoring straight A's in his science exams.",
        ...
        >
          <div className="space-y-4 lg:col-span-2">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed italic">
              "At Quranic Boarding School, our mission goes beyond academic instruction. We strive to mold young minds into upright, God-conscious leaders who carry the Holy Quran in their hearts and excel in modern sciences. Every student receives personal care in memorization, Tajweed, and character building."
            </p>
            <div>
          ...
          <div className="bg-emerald-950 p-6 rounded-2xl border border-gold-500/30 text-center text-white space-y-3">
            <div className="w-20 h-20 rounded-full bg-gold-500/20 text-gold-400 mx-auto flex items-center justify-center font-bold text-2xl border border-gold-500/40">
              QBS
            </div>
